...
import { Activity, Users, Box, TrendingUp, Ship, Zap, ArrowUpRight, ArrowDownRight, Server, Terminal, Shield, LayoutDashboard, Edit3 } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Tab Switcher */}
      <div className="inline-flex p-1 bg-white/5 border border-white/10 rounded-2xl mb-2">
        <button
          onClick={() => setActiveTab('overview')}
          className={`flex items-center gap-2 px-6 py-2 rounded-xl text-sm font-medium transition-all ${activeTab === 'overview' ? 'bg-gold-500 text-[#05080f] shadow-lg shadow-gold-500/20' : 'text-white/40 hover:text-white'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-6 py-2 rounded-xl text-sm font-medium transition-all ${activeTab === 'content' ? 'bg-gold-500 text-[#05080f] shadow-lg shadow-gold-500/20' : 'text-white/40 hover:text-white'}`}
        >
